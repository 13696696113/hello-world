...
flags = tf.app.flags
FLAGS = flags.FLAGS
flags.DEFINE_string('dataset', 'ycw', 'Dataset string.')  # 'mr','ohsumed','R8','R52'
...
flags.DEFINE_integer('input_dim', 50, 'Dimension of input.')
...
train_adj, train_mask = preprocess_adj(train_adj[:10000])
train_feature = preprocess_features(train_feature[:10000])
train_y = train_y[:10000]
print('loading validation set')
val_adj, val_mask = preprocess_adj(val_adj[:1000])
val_feature = preprocess_features(val_feature[:1000])
val_y = val_y[:1000]
print('loading test set')
test_adj, test_mask = preprocess_adj(test_adj[:1000])
test_feature = preprocess_features(test_feature[:1000])
test_y = test_y[:1000]
